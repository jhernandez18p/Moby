                    ...
                    <div className="column is-10 is-offset-1 box-animation card">
                        <div className="columns is-variable is-2 ">
                            ...
                            <div className="column is-5 has-background-info">
                                <h3 className="is-size-5 has-text-left has-text-white is-uppercase is-marginless">Productos</h3>
                            </div>

                            <div className="column is-4 has-background-info"></div>

                            <div className="column is-3 has-background-info"></div>
