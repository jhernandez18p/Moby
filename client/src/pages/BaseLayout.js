...
class Layout extends Component {
  ...
  render() {
    ...
    let blog_posts = this.props.blog_posts || 'Cargando ...';
    ...
    if (blog_posts.count === 0 || blog_tags.count === 0 || brands.count === 0 || carrousel.count === 0 || departments.count === 0 || img_carrousel.count === 0 || pages.count === 0 || products.count === 0 || services.count === 0 || site.count === 0 || social_media.count === 0 || testimonials.count === 0) {
      if (user.user.username === 'Guest' && user.isAuthenticated) {
      ...
      return (
        <div className="site pageloader has-navbar-fixed-top">
          ...
          />
          <div><UnderConstruction isUnderCostruction={isUnderConstruction} /></div>
          <div className="site-wr">
            ...
            <div className="content">
              <Switch>
                ...
                <Route exact path="/productos/departamento/:slug" render={(props) => <DepartmentDetail />} />
                <Route exact path="/productos/departamentos" render={(props) => <Department />} />
                <Route exact path="/productos/marca/:slug" render={(props) => <BrandDetail />} />
                <Route exact path="/productos/marcas" render={(props) => <Brand />} />
          ...
          <Footer site={site} blog_posts={blog_posts} />
        </div>
      );
    }
  }
